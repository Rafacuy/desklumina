...
- **Fix Bugs**: Help make DeskLumina more stable.

---

## Reporting Bugs

Before reporting a bug, search existing issues to see if it has already been reported. When creating a new issue, include:
...
- If present, include `~/.config/desklumina/logs/error.log`.
...
2.  **Create a Branch**: Use a descriptive branch name, such as `feature/my-new-tool`.
...
2. Update the documentation if you have added or changed features.
